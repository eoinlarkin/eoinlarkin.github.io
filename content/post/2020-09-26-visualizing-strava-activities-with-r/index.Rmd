...
```{r, heatmap, cache=TRUE, fig.width=7,fig.height=7}
...
```{r timeline_plot, fig.width = 10, fig.height=15,cache=TRUE}
...
```{r packed_circle_plot, fig.width=12,fig.height=10, cache=TRUE}
